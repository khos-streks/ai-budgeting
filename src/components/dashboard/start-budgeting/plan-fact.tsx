...
export function StartPlanFact() {
	...
	const handleSubmit = () => {
		...
		console.log('Starting plan-fact process with dates:', formattedDates)
		// Add your plan-fact logic here
	}

	return (
		<Dialog>
			<DialogTrigger asChild>
				<Button variant='outline' className='max-sm:w-full max-sm:text-wrap max-[380px]:h-auto!'>
